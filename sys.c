...
void getrusage(struct task_struct *p, int who, struct rusage *r)
{
	...
	case RUSAGE_CHILDREN:
		...
		r->ru_nvcsw = p->signal->cnvcsw;//Voluntary context switches
		r->ru_nivcsw = p->signal->cnivcsw;//Involuntary context switches
	...
	case RUSAGE_SELF:
		...
		r->ru_nivcsw += p->signal->nivcsw;//Involuntary context switches
		t = p;
		do {
